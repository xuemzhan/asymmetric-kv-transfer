% DRAFT 0 — Framing scaffold (disposable)
% This sets guardrails for evaluation. Will be rewritten after evaluation.
...
% Move 6: Results Preview — LEFT BLANK (filled after evaluation)
% [TODO: Add headline numbers and figure references after evaluation is complete]
