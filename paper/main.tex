...
\begin{enumerate}
  ...
  \item \textbf{Layer localization.}
    ...
    (V-only $\dll = +0.31 / +1.24$; selective joint injection $+2.15$),
...
\caption{Per-head CCA $\rho_1$ for K vs.\ V across three pairs.
...
(Figure~\ref{fig:cca}; K heads exceed V heads on 75--79\% of heads).
